...
`,yA=A.div`
  ...
  &.clicked {
    animation: ${pA} 2s forwards;

    @media (max-width: 768px) and (min-width: 320px) {
      animation: ${mA} 1.5s forwards;
      width: 80px;
      height: 25px;
      padding: 4px;
      left: 100%;
...
`;function xA({title:e,shadowColor:t}){const{card:n}=At(),r=qa(),{setRunTransition:i,triggerTransition:o}=bi(),s=window.location.pathname.replace("/My-portfolio/","").replace("/",""),a=n.find(m=>m.path===s)||n[0],l=n.findIndex(m=>m.path===s),u=a.color,c=a.backgroundColor,f=()=>{i(!0),o("previous");const m=(l-1+n.length)%n.length,y=n[m].path,x=setTimeout(()=>{i(!1),r(`/${y}`)},800);return()=>{clearTimeout(x)}},d=()=>{i(!0),o("next");const m=(l+1)%n.length,y=n[m].path,x=setTimeout(()=>{i(!1),r(`/${y}`)},800);return()=>{clearTimeout(x)}};return v.jsxs(wA,{children:[v.jsx(Rg,{className:"navigation-buttons",style:{marginRight:"3em"},children:v.jsx(et,{onClick:f,style:{color:u},color:u,shadowColor:t,backgroundColor:c,label:"Previous Project",previous:!0,width:"10em"})}),v.jsx(SA,{children:e}),v.jsx(Rg,{className:"navigation-buttons",children:v.jsx(et,{onClick:d,style:{color:u},color:u,shadowColor:t,backgroundColor:c,label:"Next Project",next:!0,width:"10em"})})]})}const wA=A.div`
  display: flex;
  flex-direction: row;  
  align-items: center;
  justify-content: center;
...
`;Gx.propTypes={descriptions:I.shape({primary:I.string,secondary:I.string,tertiary:I.string,quaternary:I.string}).isRequired,repos:I.array.isRequired,color:I.string.isRequired,backgroundColor:I.string.isRequired,showViewSwitch:I.bool.isRequired,onSwitchView:I.func.isRequired,isSwitchActive:I.bool.isRequired};function Gx({descriptions:e,repos:t,color:n,backgroundColor:r,showViewSwitch:i,onSwitchView:o,isSwitchActive:s}){const a=()=>{if(i){const l=s?t.find(u=>u.browser):t.find(u=>u.native);l&&window.open(s?l.browser:l.native,"_blank")}else window.open(Object.values(t[0])[0],"_blank")};return v.jsxs(kA,{children:[e.primary&&v.jsxs(mu,{children:[e.primary.charAt(0)&&v.jsx("span",{style:{fontSize:"1.25em",fontWeight:"bold"},children:e.primary.charAt(0)}),e.primary.slice(1)]}),e.secondary&&v.jsx(mu,{children:e.secondary}),e.tertiary&&v.jsx(mu,{children:e.tertiary}),v.jsxs(PA,{showViewSwitch:i,children:[v.jsx(CA,{children:v.jsx(bA,{color:n,children:v.jsx(et,{color:n,backgroundColor:r,small:!0,onClick:a,label:v.jsx("div",{style:{display:"flex",alignItems:"center",gap:"0.5em"},children:v.jsx(TA,{children:t[0].icon})})})})}),i&&v.jsx(EA,{children:v.jsx(AA,{children:v.jsx(et,{onClick:o,color:n,border:!0,pulse:!0,backgroundColor:r,label:s?"Show Native":"Show Website",invertedColors:!0,showViewSwitch:i})})})]})]})}const kA=A.div`
  display: flex;
  flex-direction: column;
  gap: 1.1em;
  margin: 2em 0;
...
`;function RA({color:e,images:t,scrollProgress:n,isNative:r,doubleRepo:i,isSwitchActive:o}){return v.jsx(MA,{isNative:r,isSwitchActive:o,doubleRepo:i,children:v.jsx(IA,{children:t.map((s,a)=>{const l=a/t.length,u=(a+1)/t.length,c=.1/t.length,f=Hi(n,[l-c,l+c,u-c,u+c],a===0?[1,1,1,.2]:a===t.length-1?[.1,1,1,1]:[.1,1,1,.2]),d=Jc(f,{stiffness:30,damping:12,mass:1.5,restDelta:1e-5});return v.jsx(LA,{as:Fe.div,color:e,style:{opacity:d}},a)})})},o)}const jA=le`
  from {
    opacity: 0;
  }
  to {
...
`,MA=A.div`
  ...
  z-index: 100;
  opacity: 0;
  animation: ${jA} 0.5s ease-in-out forwards;
...
`,LA=A.div`
  ...
  position: relative;
  overflow: hidden;
`,Kx=w.createContext(),NA=({children:e})=>{const[t,n]=w.useState(!1);return v.jsx(Kx.Provider,{value:{isPopoverOpen:t,setIsPopoverOpen:n},children:e})},Xx=()=>{const e=w.useContext(Kx);if(e===void 0)throw new Error("usePopover must be used within a PopoverProvider");return e},OA=({image:e,images:t=[],onClose:n,color:r,backgroundColor:i,invertedColors:o,doubleRepo:s,shadowColor:a,isNative:l})=>{const{setIsPopoverOpen:u}=Xx(),[c,f]=w.useState(t.indexOf(e)),[d,m]=w.useState(0);w.useEffect(()=>{t.indexOf(e)===-1?f(0):f(t.indexOf(e))},[e,t]),w.useEffect(()=>(u(!!e),()=>u(!1)),[e,u]);const y=()=>{m(1),f(h=>(h+1)%t.length)},x=()=>{m(-1),f(h=>(h-1+t.length)%t.length)},k=t[c],p={enter:h=>({x:h>0?300:-300,opacity:0,scale:.98,filter:"blur(4px)"}),center:{zIndex:1,x:0,opacity:1,scale:1,filter:"blur(0px)"},exit:h=>({zIndex:0,x:h<0?300:-300,opacity:0,scale:.98,filter:"blur(4px)"})};return v.jsx(nm,{children:e&&v.jsx(DA,{as:Fe.div,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},onClick:n,children:v.jsxs(_A,{isNative:l,as:Fe.div,initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.8},transition:{duration:.3},onClick:h=>h.stopPropagation(),children:[v.jsxs($A,{isNative:l,children:[v.jsx(zA,{isNative:l,children:v.jsx(nm,{mode:"wait",custom:d,initial:!1,children:v.jsx(FA,{as:Fe.img,src:k.src,alt:k.alt||"Image",custom:d,variants:p,initial:"enter",animate:"center",exit:"exit",transition:{x:{type:"spring",stiffness:200,damping:18,mass:.4,restSpeed:.5},opacity:{duration:.2,ease:"easeInOut"},scale:{duration:.2,ease:"easeOut"},filter:{duration:.15,ease:"easeOut"}},onClick:n,isNative:l,backgroundColor:i},k.src)})}),v.jsx(VA,{isNative:l,children:v.jsx(et,{color:r,backgroundColor:i,invertedColors:o,shadowColor:a,onClick:n,label:"X",padding:".7em",border:!0,hasIcon:!0,small:!0})})]}),v.jsxs(BA,{isNative:l,children:[v.jsx(et,{color:r,backgroundColor:i,invertedColors:o,shadowColor:a,onClick:x,width:"7em",label:"Previous",border:!0,title:!0,hasIcon:!0,previous:!0}),v.jsx(et,{color:r,backgroundColor:i,invertedColors:o,shadowColor:a,onClick:y,label:"Next ",width:"7em",border:!0,title:!0,hasIcon:!0,next:!0})]})]})})})},DA=A(Fe.div)`
  position: fixed;
  top: 0;
  left: 0;
  width: 100vw;
...
`;function ef({images:e=[],backgroundColor:t,color:n,invertedColors:r,isNative:i,doubleRepo:o,isSwitchActive:s,textColor:a}){const l=w.useRef(null),[u,c]=w.useState(0),[f,d]=w.useState(null),[m,y]=w.useState(null),[x,k]=w.useState(!1),{scrollYProgress:p}=Cg({container:l,offset:["start start","end end"]});w.useEffect(()=>{const S=new qd({wrapper:l.current,content:l.current,duration:1.2,orientation:"vertical",smooth:!0,smoothWheel:!0,touchMultiplier:2});y(S);function b(P){S.raf(P),requestAnimationFrame(b)}return requestAnimationFrame(b),()=>{S.destroy()}},[]);const h=(S,b)=>{const P=b===0?.1:.3;S>(b===0?.3:.5)?c(b):S<P&&b>0&&c(b-1)};if(!e||e.length===0)return null;const g=S=>{d(S),m==null||m.stop()},C=()=>{d(null),m==null||m.start()};return w.useEffect(()=>{var P;const S=()=>{var T;!x&&((T=l.current)==null?void 0:T.scrollTop)>20&&k(!0)};if(window.innerWidth<=768&&window.innerWidth>=321)return(P=l.current)==null||P.addEventListener("scroll",S),()=>{var T;return(T=l.current)==null?void 0:T.removeEventListener("scroll",S)}},[x]),v.jsxs(UA,{ref:l,isNative:i,doubleRepo:o,children:[window.innerWidth<=768&&window.innerWidth>=321&&!x&&v.jsx(XA,{color:n}),e.map((S,b)=>{const P=w.useRef(null),{scrollYProgress:T}=Cg({target:P,container:l,offset:["start 60%","center center"],default:0}),N=Hi(p||0,[0,1],[1,1-(e.length-b)*.05]),M=Hi(p||0,[0,1],[0,-((e.length-b)*15)]);m4(T,"change",R=>{h(R,b)});const B=Hi(T,[0,.5,1],[0,1,1]),Te=Hi(T,[0,.5,1],[1.5,1,1]),he=Jc(B,{stiffness:100,damping:20}),st=Jc(Te,{stiffness:100,damping:20}),Ut=S.src||S,at=S.alt||`Image ${b+1}`,U=(R,O,D)=>{const G=75/(O-1),K=15+R*G,ee=Math.min(K,90);return`color-mix(in srgb, ${D} ${ee}%, black)`};return v.jsxs(WA,{onClick:()=>g(S),ref:P,isFirst:b===0,isLast:b===e.length-1,isNative:i,textColor:a,style:{backgroundColor:U(b,e.length,r?n:t),color:r?t:n,top:i?`${b*10}px`:`${b*10}px`,marginBottom:b===e.length-1?"40vh":"0",scale:N,y:M},children:[v.jsx(HA,{children:v.jsx(YA,{children:S.info})}),v.jsx(GA,{isNative:i,children:v.jsx(KA,{src:Ut,alt:at,style:{opacity:he,scale:st}})})]},S.id||b)}),v.jsx(OA,{image:f,images:e,onClose:C,color:n,backgroundColor:t,invertedColors:r,isNative:i,doubleRepo:o}),v.jsx(RA,{color:n,images:e,scrollProgress:p,isNative:i,doubleRepo:o,isSwitchActive:s})]})}const UA=A.div`
  position: relative;
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,QA=({nativeImages:e,browserImages:t,backgroundColor:n,color:r,invertedColors:i,doubleRepo:o,isSwitchActive:s})=>{const a={nativeView:{x:0,opacity:1,transition:{duration:.5,ease:"easeInOut"}},browserView:{x:"-100%",opacity:0,transition:{duration:.5,ease:"easeInOut"}}},l={nativeView:{x:"100%",opacity:0,transition:{duration:.5,ease:"easeInOut"}},browserView:{x:0,opacity:1,transition:{duration:.5,ease:"easeInOut"}},hidden:{x:"100%",opacity:0}};return v.jsx(qA,{children:v.jsxs(ZA,{children:[v.jsx(jg,{variants:a,animate:s?"browserView":"nativeView",initial:"nativeView",children:v.jsx(ef,{images:e,backgroundColor:n,color:r,invertedColors:i,isNative:!0,isSwitchActive:s,doubleRepo:o})}),v.jsx(jg,{variants:l,animate:s?"browserView":"nativeView",initial:"hidden",isSwitchActive:s,style:{position:"absolute",width:"100%",height:"100%",right:s?"5em":"0"},children:v.jsx(ef,{images:t,backgroundColor:n,color:r,invertedColors:i,isNative:!1,isSwitchActive:s,doubleRepo:o})})]})})},qA=A.div`
  position: relative;
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,u6=A(Fe.div)`
  ...
  z-index: 1000;
  background-color: ${e=>e.color};
  animation: ${e=>e.direction==="next"?a6:l6} 0.7s ease-in-out forwards;
`;function c6(){const{card:e}=At(),t=e.find(s=>s.path==="chatapp"),[n,r]=w.useState(!0),[i,o]=w.useState(!1);return v.jsxs(v.Fragment,{children:[v.jsx(Zo,{title:t.title,descriptions:t.descriptions,repos:t.repos,nativeImages:t.images.nativeImage,isNative:n,isBrowser:i,previousPage:!0,nextPage:!0}),v.jsx(Jo,{})]})}function f6(){const{runTransition:e}=bi(),{card:t}=At(),n=t.find(o=>o.path==="webbshop"),[r,i]=w.useState(!0);return v.jsxs(v.Fragment,{children:[v.jsx(Zo,{title:n.title,descriptions:n.descriptions,browserImages:n.images.browserImage,repos:n.repos,isBrowser:r}),e===!0?v.jsx(Jo,{}):""]})}function d6(){const{runTransition:e}=bi(),{card:t}=At(),n=t.find(r=>r.path==="movieapp");return v.jsxs(v.Fragment,{children:[v.jsx(Zo,{title:n.title,descriptions:n.descriptions,repos:n.repos,nativeImages:n.images.nativeImage,browserImages:n.images.browserImage,isNative:!0,isBrowser:!0}),e===!0?v.jsx(Jo,{}):""]})}function h6(){const{card:e}=At(),t=e.find(n=>n.path==="cleaning");return v.jsxs(v.Fragment,{children:[v.jsx(Zo,{title:t.title,descriptions:t.descriptions,repos:t.repos,browserImages:t.images.browserImage,invertedColors:!0}),v.jsx(Jo,{})]})}function p6(){const{main:e}=At(),t=w.useRef(null),n=w.useRef(null),[r,i]=w.useState(null),[o,s]=w.useState(0),[a,l]=w.useState("");w.useState(!1),w.useEffect(()=>{if(window.matchMedia("(max-width: 768px) and (min-width: 320px)").matches){let d=function(y){m.raf(y),requestAnimationFrame(d)};const m=new qd({duration:1.2,orientation:"vertical",smooth:!0,smoothWheel:!0,touchMultiplier:2});return i(m),requestAnimationFrame(d),()=>{m.destroy()}}},[]),w.useEffect(()=>{const f=setInterval(()=>{s(d=>d===Object.keys(e.images).length-1?0:d+1)},3e3);return()=>clearInterval(f)},[e.images]);const u=f=>{Object.keys(f)[0]==="email"?(l("Email copied!"),navigator.clipboard.writeText("emil.stjernlof@gmail.com"),setTimeout(()=>{l("")},3e3)):Object.keys(f)[0]==="browser"?window.open(f.browser,"_blank"):Object.keys(f)[0]==="linkedin"&&window.open(f.linkedin,"_blank")},c=f=>{f.song&&window.open(f.song,"_blank")};return v.jsx(v6,{ref:t,children:v.jsxs(y6,{ref:n,children:[v.jsxs(x6,{children:[v.jsx("h2",{children:e.title}),v.jsx(Cs,{delay:"0.2s",children:v.jsx("p",{children:e.descriptions.primary})}),v.jsx(Cs,{delay:"0.3s",children:v.jsx("p",{children:e.descriptions.secondary})}),v.jsx(Cs,{delay:"0.4s",children:v.jsx("p",{children:e.descriptions.tertiary})}),v.jsx(Cs,{delay:"0.5s",children:v.jsx("p",{children:e.descriptions.quaternary})})]}),v.jsxs(w6,{children:[v.jsxs(S6,{children:[v.jsx(k6,{children:Object.values(e.images).map((f,d)=>v.jsx(C6,{src:f,alt:`profile picture ${d+1}`,active:d===o},f))}),v.jsxs(b6,{children:[v.jsx(P6,{children:v.jsx(T6,{children:"What's in my headphones?"})}),e.music.map((f,d)=>v.jsx(E6,{children:v.jsx(A6,{children:v.jsx(et,{color:e.color,backgroundColor:e.backgroundColor,onClick:()=>c(f),width:"100%",height:"100%",border:!0,label:v.jsxs(Mg,{children:[e.musicIcon,v.jsx(R6,{children:v.jsxs(j6,{shouldScroll:f.songtitle.length>10,duration:`${f.songtitle.length*.6}s`,children:[f.songtitle," "]})})]})},d)})},d))]})]}),v.jsx(M6,{children:e.repos.map((f,d)=>v.jsx(I6,{children:v.jsx(et,{color:e.color,backgroundColor:e.backgroundColor,onClick:()=>u(f),label:v.jsx(Mg,{children:f.icon}),showCopyAlert:Object.keys(f)[0]==="email"&&a,copyMessage:a,small:!0})},d))})]})]})})}const Qx=le`
  from {
    opacity: 0;
  }
  to {
...
`,j6=A.div`
  ...
  font-family: "Lato", sans-serif;
  ${e=>e.shouldScroll&&rl`
      animation: ${g6} ${t=>t.duration||"8s"} infinite;
      padding-right: 2em;
    `}
...
`;function Yn({about:e,setIsHoverButton:t}){const[n,r]=w.useState(""),[i,o]=w.useState(!1),[s,a]=w.useState(!1),[l,u]=w.useState(!1),[c,f]=w.useState(""),[d,m]=w.useState(!1),{card:y,main:x}=At(),k=qa(),{isPopoverOpen:p}=Xx(),h=window.location.pathname.replace("/My-portfolio/","").replace("/",""),g=y.find(B=>B.path===h)||y[0];let C=g.color,S=g.backgroundColor,b=g.shadow;(h==="about"||h==="")&&(C=x.backgroundColor,S=x.color,b=x.shadow);const P=Qa(),T="emil.stjernlof@gmail.com";w.useEffect(()=>{m(!0);const B=setTimeout(()=>{r("")},3e3);return()=>clearTimeout(B)},[n]),w.useEffect(()=>{m(!1);const B=setTimeout(()=>{m(!0)},100);return()=>clearTimeout(B)},[P.pathname]);function N(){navigator.clipboard.writeText(T),r("Email copied!"),o(!0),setTimeout(()=>{o(!1)},200)}const M=(B,Te)=>{a(!0),u(!0),f(Te);const he=setTimeout(()=>{a(!1),k(B),u(!1)},800);return()=>{clearTimeout(he)}};return v.jsxs(v.Fragment,{children:[l&&v.jsx(_6,{color:s?c:""}),v.jsxs(O6,{isPopoverOpen:p,path:h,color:C,backgroundColor:S,shadow:b,fadeIn:d,about:e,children:[P.pathname!=="/"?v.jsx(et,{color:C,backgroundColor:S,invertedColors:e,onClick:()=>M("/","white"),label:"Home"}):null,P.pathname!=="/about"?v.jsx(et,{color:C,backgroundColor:S,invertedColors:e,onClick:()=>M("/about","var(--dark)"),label:"About me"}):null,v.jsx(D6,{className:i?"active":"",children:v.jsx(et,{color:C,backgroundColor:S,invertedColors:e,onClick:N,label:"Contact",copyMessage:n,showCopyAlert:!0})})]})]})}const L6=le`
  0% {
    transform: scale(0);
    opacity: 1;
  }
...
`,_6=A.div`
  ...
  border-radius: 50%;
  background-color: ${e=>e.color};
  animation: ${L6} 0.7s ease-in-out forwards;
  transform-origin: center;
  z-index: 9999;
  opacity: 1;
  ...
  @media (max-width: 768px) and (min-width: 320px) {
    ...
    bottom: 50%;
    transform: translate(50%, 50%);
    animation: ${N6} 1s ease-in-out forwards;
  }
`;function z6(){const{card:e}=At(),t=e.find(n=>n.path==="dashboard");return v.jsxs(v.Fragment,{children:[v.jsx(Zo,{title:t.title,descriptions:t.descriptions,repos:t.repos,browserImages:t.images.browserImage,isBrowser:!0,invertedColors:!1}),v.jsx(Jo,{})]})}const F6=()=>v.jsx($6,{children:v.jsx(V6,{children:"ES"})}),$6=A.div`
  display: flex;
  height: 100vh;
  min-width: 90vw;
  align-items: center;
...
`,Y6=A.h4`
 ...
 `;function G6(){const{runTransition:e}=bi(),t=Qa(),[n,r]=w.useState(""),[i,o]=w.useState(!0),[s,a]=w.useState(!1),[l,u]=w.useState(!1),[c,f]=w.useState(""),[d,m]=w.useState(""),[y,x]=w.useState(!0),[k,p]=w.useState(1),h="/",g="/cleaning",C="/chatapp",S="/webbshop",b="/movieapp",P="/dashboard";return w.useEffect(()=>{let T="",N="";switch(t.pathname){case h:N="var(--dark)";break;case g:T="var(--yellowish)",N="var(--dark)";break;case S:T="var(--greenish)",N="var(--bisque)";break;case C:T="var(--light-purple)",N="var(--neon-green)";break;case b:T="var(--darker)",N="var(--redish)";break;case P:T="var(--blueish)",N="var(--light-blueish)";break;case"/about":T="white",N="white";break;default:T=""}p(0),setTimeout(()=>{r(T),p(1),m()},300),f(N)},[t.pathname]),w.useEffect(()=>{const T=setTimeout(()=>o(!1),3200);return()=>clearTimeout(T)},[]),w.useEffect(()=>{e&&(x(!1),setTimeout(()=>x(!0)))},[e]),v.jsx(v.Fragment,{children:i?v.jsx(F6,{}):v.jsx(ll,{children:v.jsxs(NA,{children:[v.jsx(U6,{isHoverButton:l,isHoveringCards:s,cursorColor:c,cursorHoverColor:d}),v.jsx(K6,{color:n,children:v.jsx(Yx,{children:v.jsx(X6,{children:v.jsxs(pk,{children:[v.jsx(hn,{path:h,element:v.jsxs(Gn,{children:[v.jsx(Yn,{path:h,setIsHoverButton:u}),v.jsx(q4,{setCursorHoverColor:m,setIsHoveringCards:a})]})}),v.jsx(hn,{path:g,element:v.jsxs(Gn,{className:"scrollCleaning",children:[v.jsx(Yn,{path:g,setIsHoverButton:u}),v.jsx(h6,{})]})}),v.jsx(hn,{path:C,element:v.jsxs(Gn,{className:"scrollChatApp",children:[v.jsx(Yn,{path:C,setIsHoverButton:u}),v.jsx(c6,{})]})}),v.jsx(hn,{path:S,element:v.jsxs(Gn,{className:"scrollWebbShop",children:[v.jsx(Yn,{path:S,setIsHoverButton:u}),v.jsx(f6,{})]})}),v.jsx(hn,{path:b,element:v.jsxs(Gn,{className:"scrollMovies",children:[v.jsx(Yn,{path:b,setIsHoverButton:u}),v.jsx(d6,{})]})}),v.jsx(hn,{path:P,element:v.jsxs(Gn,{children:[v.jsx(Yn,{path:P,setIsHoverButton:u}),v.jsx(z6,{})]})}),v.jsx(hn,{path:"/about",element:v.jsxs(Gn,{children:[v.jsx(Yn,{path:"/about",about:!0}),v.jsx(p6,{})]})})]})})})})]})})})}const K6=A.div`
  display: flex;
  height: 100vh;
  position: relative;
  overflow: hidden;
...
`;gu.createRoot(document.getElementById("root")).render(v.jsx(Zt.StrictMode,{children:v.jsx(gk,{basename:"/My-portfolio/",children:v.jsx(Yx,{children:v.jsx(vC,{children:v.jsx(ll,{children:v.jsx(G6,{router:ty})})})})})}));
