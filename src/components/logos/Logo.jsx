...
const Logo = ({ logo }) => {
  const renderLogoContent = () => {
    switch (logo) {
      ...
      case 2:
        return <div style={styles.dashboard}><span style={{color: 'var(--light-blueish)'}}>/</span>Daily Helper<span style={{color: 'var(--light-blueish)'}}>/</span> </div>;
      case 3:
        ...
        return (
          <div style={styles.chatContainer}>
            ...
            <div style={styles.chatRow}>
              <div style={{ ...styles.classChat, marginLeft: "55px" }}>
                Chat
              </div>
