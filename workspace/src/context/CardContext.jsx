...
export const CardProvider = ({ children }) => {
  ...
  const card = [
    { id: 1, title: "Cleaning", path: 'cleaning', label: "React.js", color: 'var(--dark)', backgroundColor: 'var(--yellowish)'  },
    ...
    { id: 3, title: "The webb shop", path: 'webbshop', label: "React.js", color: 'bisque', backgroundColor: 'var(--greenish)', shadow: 'var(--shadow-bisuqe)'  },
